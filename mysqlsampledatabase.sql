/*
 Esquema de banco de dados de amostra do MySQL
 O esquema do banco de dados de exemplo MySQL consiste nas seguintes tabelas:

Clientes : armazena os dados do cliente.
Produtos : armazena uma lista de miniaturas de carros.
ProductLines : armazena uma lista de categorias de linhas de produtos.
Pedidos : armazena os pedidos de vendas feitos pelos clientes.
OrderDetails : armazena os itens de linha do pedido de venda para cada pedido de venda.
Pagamentos : armazena os pagamentos feitos pelos clientes com base em suas contas.
Funcionários : armazena todas as informações dos funcionários, bem como a estrutura da organização, como quem se reporta a quem.
Escritórios : armazena os dados do escritório de vendas.
*/
/*
*********************************************************************
